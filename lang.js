...
const TRANSLATIONS = {
    th: {
        ...
        'category.custom_color_title': 'เลือกสีอื่นๆ',
        ...
        // ========== Savings (เงินเก็บ) ==========
        'savings.title': 'เงินเก็บสะสม',
        'savings.total': 'ยอดเงินเก็บรวม',
        'savings.from_cash': 'จากเงินสด',
        'savings.from_bank': 'จากธนาคาร',
        'savings.manage': 'จัดการเงินเก็บ',
        'savings.view_history': 'ดูประวัติ',
        'savings.modal_title': 'จัดการเงินเก็บ',
        'savings.deposit': 'เก็บเงิน (Deposit)',
        'savings.withdraw': 'ถอนเงินเก็บ (Withdraw)',
        'savings.amount': 'จำนวนเงิน',
        'savings.source': 'แหล่งที่มา',
        'savings.source_cash': '💵 จากเงินสด',
        'savings.source_bank': '🏦 จากธนาคาร',
        'savings.date': 'วันเวลาที่ทำรายการ',
        'savings.description': 'บันทึกเพิ่มเติม',
        'savings.description_placeholder': 'เช่น เก็บเงินเดือน, ฉุกเฉิน...',
        'savings.submit_deposit': 'เก็บเงิน',
        'savings.submit_withdraw': 'ถอนเงินเก็บ',
        'savings.history_title': 'ประวัติเงินเก็บ',
        'savings.back': 'กลับหน้าหลัก',
        'savings.empty_title': 'ยังไม่มีรายการเงินเก็บ',
        'savings.empty_desc': 'กดปุ่ม "จัดการเงินเก็บ" เพื่อเริ่มเก็บออม',
        'savings.deposit_label': 'เก็บเงิน',
        'savings.withdraw_label': 'ถอนเงินเก็บ',
        'savings.saved_from_cash': 'เก็บไป (จากเงินสด)',
        'savings.saved_from_bank': 'เก็บไป (จากธนาคาร)',
        'savings.net_balance': 'คงเหลือสุทธิ',
        'toast.savings_added': 'บันทึกเงินเก็บเรียบร้อย!',
        'toast.savings_withdrawn': 'ถอนเงินเก็บเรียบร้อย!',
        'toast.savings_error': 'ไม่สามารถบันทึกเงินเก็บได้',
        'toast.savings_deleted': 'ลบรายการเงินเก็บเรียบร้อย',
        'toast.savings_delete_error': 'ไม่สามารถลบรายการเงินเก็บได้',
        'confirm.delete_savings': 'คุณแน่ใจว่าต้องการลบรายการเงินเก็บนี้ใช่ไหม?',
    ...
    en: {
        ...
        'category.custom_color_title': 'Choose other colors',
        ...
        'savings.from_cash': 'From Cash',
        'savings.from_bank': 'From Bank',
        'savings.manage': 'Manage Savings',
        'savings.view_history': 'View History',
        'savings.modal_title': 'Manage Savings',
        'savings.deposit': 'Deposit',
        'savings.withdraw': 'Withdraw',
        'savings.amount': 'Amount',
        'savings.source': 'Source',
        'savings.source_cash': '💵 From Cash',
        'savings.source_bank': '🏦 From Bank',
        'savings.date': 'Date & Time',
        'savings.description': 'Notes',
        'savings.description_placeholder': 'e.g. Monthly savings, emergency fund...',
        'savings.submit_deposit': 'Save Money',
        'savings.submit_withdraw': 'Withdraw',
        'savings.history_title': 'Savings History',
        'savings.back': 'Back to Home',
        'savings.empty_title': 'No savings yet',
        'savings.empty_desc': 'Click "Manage Savings" to start saving',
        'savings.deposit_label': 'Deposit',
        'savings.withdraw_label': 'Withdraw',
        'savings.saved_from_cash': 'Saved (from Cash)',
        'savings.saved_from_bank': 'Saved (from Bank)',
        'savings.net_balance': 'Net Balance',
        'toast.savings_added': 'Savings recorded successfully!',
        'toast.savings_withdrawn': 'Withdrawal recorded successfully!',
        'toast.savings_error': 'Failed to save savings data',
        'toast.savings_deleted': 'Savings entry deleted',
        'toast.savings_delete_error': 'Failed to delete savings entry',
        'confirm.delete_savings': 'Are you sure you want to delete this savings entry?',
